...
class Config {
    ...
    static admin_password_hash = "$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi";
    
    static render_url = process.env.RENDER_URL || "https://your-app.onrender.com";
    static ping_interval = 3600;
    static render_ping_interval = 25;
